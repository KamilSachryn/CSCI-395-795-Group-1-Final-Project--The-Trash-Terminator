...
public class school_VRlookWalk : MonoBehaviour
{
    public school_HealthBarController healthbar;
    public static school_VRlookWalk player;
    bool alive = true;
    bool played = false;
    ...
    public school_GameOver gameover;
    [SerializeField] Canvas score;
    public void GameOverPage()
    {
        score.enabled = false;
        hands.SetActive(false);
        gameover.Setup(school_GameManager.inst.score);
